...
output_home="/home/comp/19481691/kangxueze/reft_plus/Megatron-DeepSpeed/output"
...
tensorboard_dir="/home/comp/19481691/kangxueze/reft_plus/Megatron-DeepSpeed/tensorboard"
tensorboard_path=""
if [ "${log_path}" != "" ]; then
    mkdir -p ${log_path}
fi
...
deepspeed ${dir}/../../../../pretrain_bert.py ${megatron_options} ${data_options} ${deepspeed_options}