...
def load(args):
    ...
    def _cpp_extention_load_helper(name, sources, extra_cuda_flags, extra_include_paths):
        ...
        # print("cpp_extension.load ninja available:", cpp_extension.is_ninja_available())
    ...
    if args.masked_softmax_fusion:
        ...
        # print("_cpp_extention_load_helper ninja available:", cpp_extension.is_ninja_available())
