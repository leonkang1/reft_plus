...
def _build_doc_idx(documents, num_epochs, np_rng, separate_last_epoch):
    ...
    if not separate_last_epoch or num_epochs == 1:
        # Generate indices for each document for all epochs at once, then shuffle
        print("tile")
    ...
    # If treating the last epoch separately, shuffle indices for the first (num_epochs - 1) and separately for the last epoch
    print("tile out")
    doc_idx_first = np.tile(documents, num_epochs - 1)
    print("shuffle 1")
    np_rng.shuffle(doc_idx_first)
    print("array")
    doc_idx_last = np.array(documents)
    print("shuffle 2")
    np_rng.shuffle(doc_idx_last)
