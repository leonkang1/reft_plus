...
def initialize_megatron(extra_args_provider=None, args_defaults={},
    ...
    if  args.lazy_mpu_init:
        ...
        # print("_compile_dependencies() ninja available", cpp_extension.is_ninja_available())
...
def _compile_dependencies():
    ...
    if is_rank_0():
        ...
        if get_accelerator().device_count() > 0: # Skip when CPU-only
            from torch.utils import cpp_extension
            # print("fused_kernels.load(args) ninja available:", cpp_extension.is_ninja_available())
